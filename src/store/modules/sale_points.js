...
export default {
    ...
    actions:{
        setAddedSP({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionSP({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoSP({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdSP({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async deleteItemSP({ commit }, payload) { 
        ...
        async editItemSP({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemSP({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
