<template >
    <div id="AddGlp">
        ...
        <div class="form-content">
            <form @submit.prevent="
                submit(
                shipping_price,free_shipping,texto
                )
              ">
                    ...
                    <div class="grup-form dflx">
                        <div class="boxform">
                                <label for="shipping_price" class="shipping_price">Precio fijo envio local</label>
                                <input
                             ...
                             <div class="boxform">
                                <label for="free_shipping" class="free_shipping">Envío gratis a partir de <span>**Para desactivar <b>envios gratis</b> indicar '0'.</span></label>
                                <input
...
export default {
    ...
    methods:{
        ...
        submit: async function( shipping_price,free_shipping,texto){
                 this.status =''
                 this.message =''
           let data ={
                    shipping_price,free_shipping,texto
                    ...
                    let result = await this.$store.dispatch("global_params/addItemGlp",  {option:'global_params', item: data});
