...
export default {
    ...
    actions:{
        setAddedCQ({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionCQ({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoCQ({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdCQ({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async deleteItemCQ({ commit }, payload) { 
        ...
        async editItemCQ({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemCQ({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
