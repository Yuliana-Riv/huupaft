<template>
  <div id="AddBlo">
    <div class="form-content">
      <form @submit.prevent="submit(fullname, quote, file1)">
...
export default { 
  ...
  methods: {
    ...
    submit: async function (fullname, quote, file1) {
      ...
      let result = await this.$store.dispatch("clients_quotes/addItemCQ", {
    ...
    srcImg: function (img) {
      let src = `${urlpath.url()}/Y4k_o1b/lw4-ufj/clients_quotes-img/${img}`;
