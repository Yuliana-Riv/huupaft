<template>
  <div>
    <div class="B1">
      <p class="B1T1">ENCUENTRA TU <span>SABOR IDEAL</span> </p>
    ...
    <section v-if="data2 !== 'No se encontraron coincidencias'">
      <div class="B2">
        <div
          class="B2B"
          v-for="(item, key) in data2.slice(0, 4)"
          :key="key"
        >
...
.B2 {
  padding-top: 0.091787439613526vw;
  padding-bottom: 0;
}
.B2Item {
  text-align: center;
