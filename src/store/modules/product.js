...
export default {
    ...
    actions:{
        setAddedPro({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionPro({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoPro({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getAllInfoPro2({ commit }, payload) {
        ...
        async getAllInfoPro3({ commit }, payload) {
        ...
        async getInfoByIdPro({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async findByCategoryNamePro({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async findByCategoryNamePro2({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async findByUrlPro({ commit }, payload) {
        ...
        async searchPro2({ commit }, payload) {
            commit(GETTING_INFO2);
            commit(GETTING_MSG2);
            let option = payload.option
            let search = payload.search;
        ...
        async deleteItemPro({ commit }, payload) { 
        ...
        async editItemPro({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemPro({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
        ...
        async addImagesProd({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
        ...
        async deleteImageProd({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
                let response = await api.deleteItem(payload, token);
