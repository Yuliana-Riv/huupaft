<template >
    <div id="EditGlp">
            ...
            <form @submit.prevent="
                submit(
                 added.shipping_price, added.free_shipping, added.texto
                )
              ">
                     ...
                     <div class="grup-form dflx">
                       <div class="boxform">
                             ...
                             <div class="boxform">
                                <label for="free_shipping" class="free_shipping">Envío gratis a partir de
        ...
        ...mapActions("global_params", ["getInfoByIdGlp"]),
            ...
            let data ={
                    ...
                    shipping_price,free_shipping,texto
                        ...
                        let result = await this.$store.dispatch("global_params/editItemGlp",  {option:'global_params', item: data});
