        ...
        <div tbl_content>
          ...
          >
            ...
            >
              ...
              <div class="tbl_item">
                <p>{{ item.autor_name + " " + item.autor_lastname }}</p>
              </div>
              <div class="tbl_item">
...
import AddBlo from "./addBlog.vue";
import EditBlo from "./editBlog.vue";
...
export default {
  ...
  updated() {
    if (this.search_value != this.updsearchcli) {
      ...
      if (value != "") {
        this.$store.dispatch("blog/searchBlo", payload);
      } else {
        this.getAllInfoBlo("blog");
      }
    }
  ...
  methods: {
    ...
    changeView(option, item) {
      this.item = item;
      this.setAddedBlo(item);
      this.setHistoryOptionBlo(option);
    },
