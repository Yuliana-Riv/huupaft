...
import AddU from "./addClb.vue";
import EditU from "./editClb.vue";
export default {
  name: "Colaboradores",
  components: {
    AddU,
  ...
  computed: {
    data() {
      ...
      let data =this.$store.getters["colaboradores/data"];
...
return data
  ...
  methods: {
    ...
    eliminar: async function () {
      ...
      let result = await this.$store.dispatch("colaboradores/deleteItemClb", {
