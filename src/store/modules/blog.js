...
export default {
    ...
    actions:{
        setAddedBlo({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionBlo({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoBlo({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getAllInfoBlo2({ commit }, payload) {
        ...
        async getAllInfoBlo3({ commit }, payload) {
        ...
        async getInfoByIdBlo({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async getInfoByUrlBlo({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchBlo({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async searchBlo3({ commit }, payload) {
            commit(GETTING_INFO3);
            commit(GETTING_MSG);
            let option = payload.option
            let search = payload.search;
        ...
        async deleteItemBlo({ commit }, payload) { 
        ...
        async editItemBlo({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemBlo({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
