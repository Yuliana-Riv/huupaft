  ...
  watch: {
        $route: {
            ...
            handler(to, from) {
                ...
                document.title = to.meta.title || `Finalizado - Huupa`;
            }
        },
  },
  methods:{
...
.f1 .colCont {
  ...
  .tabla-pedido .rowCont .pricing-it p.titulo-1.second-c.totale {
    color: #E42828;
    font-family: var(--tlFont);
    font-weight: 400;
}
