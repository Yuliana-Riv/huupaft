...
export default {
    ...
    actions:{
        setAddedProVal({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionProVal({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoProVal({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getAllInfoProVal2({ commit }, payload) {
        ...
        async getAllProVal3({ commit }, payload) {
            commit(GETTING_INFO3);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;

                let response = await api.getAllInfo(payload, headers);
        ...
        async getInfoByIdProVal({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async getInfoByIdProVal2({ commit }, payload) {
            commit(GETTING_INFO2);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchProVal({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemProVal({ commit }, payload) { 
        ...
        async editItemProVal({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemProVal({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS') 
            try {               
                let token = userService.getToken() 
        ...
        async addImagesProVal({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
        ...
        async deleteImageProVal({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
                let response = await api.deleteItem(payload, token);
