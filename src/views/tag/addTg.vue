    ...
    methods:{
        ...
        submit: async function( name ){
           ...
           let data ={
                    ...
                    let result = await this.$store.dispatch("tag/addItemTg",  {option:'tag', item: data});
                   
                    if(result.status=='error'){
                        this.status='error'
                        this.message= result.message
                    }else{ // success
                         this.setAddedTg(result.added )
                       this.showModal()
