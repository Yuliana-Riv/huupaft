...
export default {
    ...
    actions:{
        setAddedTg({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionTg({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoTg({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdTg({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async deleteItemTg({ commit }, payload) { 
        ...
        async editItemTg({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemTg({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
