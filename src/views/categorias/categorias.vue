              ...
              if(!Array.isArray(arr)){
                return []
                  ...
                  let filt1 =[]
                    ...
                    if(arr[i].name != 'INICIO' && arr[i].id != 1){
                      filt1.push(arr[i])
                    }
                  }

                  if(this.search_value !=''){
                    for (const item of filt1) {
       ...
       ...mapActions('category', ['getAllInfoCat']),
         ...
         ...mapActions('category', ['setAddedCat']),
           ...
           changeView(option, item){
             this.item=item
             this.setAddedCat(item)
             this.setHistoryOptionCat(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("category/deleteItemCat", {option: 'category', id:id});
