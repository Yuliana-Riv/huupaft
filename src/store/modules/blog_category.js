...
export default {
    ...
    actions:{
        setAddedBct({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionBct({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoBct({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdBct({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchBct({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemBct({ commit }, payload) { 
        ...
        async editItemBct({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemBct({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
